            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                <div class="position-sticky pt-3 min-vh-100">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active text-white" aria-current="page" href="dashboard.html">
                                <span data-feather="home"></span>
                                <i class="fas fa-tachometer-alt ms-3"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-white-50" aria-current="page" href="dashboard/vehicle.html">
                                <span data-feather="home"></span>
                                <i class="fas fa-users ms-3"></i> Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-white-50" aria-current="page" href="dashboard/categories.html">
                                <span data-feather="home"></span>
                                <i class="fas fa-blog ms-3"></i> Posts
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-white-50" aria-current="page" href="dashboard/customers.html">
                                <span data-feather="home"></span>
